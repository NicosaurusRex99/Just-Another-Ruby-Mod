...
public class MultiToolBase extends ToolItem {
    ...
    public MultiToolBase(String name, IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder) {
