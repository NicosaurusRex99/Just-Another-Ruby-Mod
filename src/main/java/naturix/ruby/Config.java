...
public class Config {
    ...
    public static ForgeConfigSpec.IntValue AMETHYSTTRIES;
    ...
    public static ForgeConfigSpec.IntValue BRAUNITETRIES;
    public static ForgeConfigSpec.IntValue METEORITEVEIN;
    public static ForgeConfigSpec.IntValue METEORITETRIES;
    ...
    public static ForgeConfigSpec.IntValue OPALTRIES;
    ...
    public static ForgeConfigSpec.IntValue RUBYTRIES;
    ...
    private static void setupConfig() {
        ...
        AMETHYSTTRIES = COMMON_BUILDER.comment("Spawn tries for amethyst")
                .defineInRange("Amethyst Tries", 1, 1, 512);
        ...
        BRAUNITETRIES = COMMON_BUILDER.comment("Spawn tries for braunite")
                .defineInRange("Braunite Tries", 1, 1, 512);
        METEORITEVEIN = COMMON_BUILDER.comment("Maximum vein size of meteorite")
                .defineInRange("Meteorite Vein", 3, 1, 512);
        METEORITETRIES = COMMON_BUILDER.comment("Spawn tries for meteorite")
                .defineInRange("Meteorite Tries", 1, 1, 512);
        ...
        OPALTRIES = COMMON_BUILDER.comment("Spawn tries for opal")
                .defineInRange("Opal Tries", 2, 1, 512);
        ...
        RUBYTRIES = COMMON_BUILDER.comment("Spawn tries for ruby")
                .defineInRange("Ruby Tries", 2, 1, 512);
