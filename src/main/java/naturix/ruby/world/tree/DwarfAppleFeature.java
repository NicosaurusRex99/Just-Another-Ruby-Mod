...
public class DwarfAppleFeature extends TreeFeatureBase
{
    public static class Builder extends InnerBuilder<Builder, DwarfAppleFeature>
    {
        @Override
        public DwarfAppleFeature create()
        {
            return new DwarfAppleFeature(this.updateNeighbours, this.placeOn, this.replace, ModBlocks.log.getDefaultState(), ModBlocks.leaves.getDefaultState(), ModBlocks.leaves.getDefaultState(), this.vine, this.hanging, this.trunkFruit, this.minHeight, this.maxHeight, this.leafLayers, this.leavesOffset, this.maxLeavesRadius, this.leavesLayerHeight, this.placeVinesOn, this.hangingChance);
        }
    }
    ...
    protected DwarfAppleFeature(boolean notify, IBlockPosQuery placeOn, IBlockPosQuery replace, BlockState log,
