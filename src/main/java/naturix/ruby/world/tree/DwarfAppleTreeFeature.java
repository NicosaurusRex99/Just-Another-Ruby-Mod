...
public class DwarfAppleTreeFeature extends TreeFeatureBase
{
    public static class Builder extends InnerBuilder<Builder, DwarfAppleTreeFeature>
    {
        @Override
        public DwarfAppleTreeFeature create()
        {
            return new DwarfAppleTreeFeature(this.updateNeighbours, this.placeOn, this.replace, this.log, this.leaves, this.altLeaves, this.vine, this.hanging, this.trunkFruit, this.minHeight, this.maxHeight, this.leafLayers, this.leavesOffset, this.maxLeavesRadius, this.leavesLayerHeight, this.placeVinesOn, this.hangingChance);
        }
    }
    ...
    public DwarfAppleTreeFeature(boolean notify, IBlockPosQuery placeOn, IBlockPosQuery replace, BlockState log,
