...
public class BasicTree extends AbstractTreeFeature<NoFeatureConfig> {
    private static final BlockState DEFAULT_TRUNK = ModBlocks.log.getDefaultState();
    private static final BlockState DEFAULT_LEAF = ModBlocks.leaves.getDefaultState();
