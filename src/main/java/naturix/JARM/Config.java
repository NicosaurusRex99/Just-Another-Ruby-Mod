...
public class Config {
    ...
    public static int rubyDamage = 9;
    ...
    private static void initGeneralConfig(Configuration cfg) {
        ...
        rubyDamage = cfg.getInt("rubyDamage", CATEGORY_GENERAL, 9, 0, 2400000, "choose a number between 0 and 2400000to change the damage on the ruby sword");
    }
