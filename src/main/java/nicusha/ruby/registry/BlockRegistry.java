...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> OPAL_BLOCK = createOreBlock("opal_block", Material.STONE, MaterialColor.COLOR_LIGHT_BLUE, 2, 4, DIAMOND, SoundType.STONE, true);
    public static final RegistryObject<Block> RUBY_BLOCK = createOreBlock("ruby_block", Material.STONE, MaterialColor.COLOR_RED, 2, 4, DIAMOND, SoundType.STONE, true);

    private static RegistryObject<Block> createOreBlock(@Nonnull String id, Material material, MaterialColor color, float hardness, float resistance, float harvestLevel, SoundType sound, boolean fullBlock){
        if(fullBlock){
